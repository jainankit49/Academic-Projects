...
\@x{}\moduleLeftDash\@xx{ {\MODULE} beans}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Integers}%
\@x{ {\CONSTANTS} R ,\, G ,\, B}%
\@pvspace{8.0pt}%
\@x{ {\ASSUME}\@s{4.1} \.{\land} R \.{\in} 0 \.{\dotdot} 200}%
\@x{\@s{50.54} \.{\land} G \.{\in} 0 \.{\dotdot} 200}%
\@x{\@s{50.54} \.{\land} B\@s{0.54} \.{\in} 0 \.{\dotdot} 200}%
\@pvspace{8.0pt}%
\pcalsymbolstrue
\pcalshadingtrue
\csyntaxtrue
\@x{ {\p@mmfair} {\p@algorithm} beansAlgo {\p@lbrace}}%
 \@x{\@s{12.29} {\p@variable} red \.{=} R ,\, blue \.{=} B ,\, green \.{=} G
 {\p@semicolon}}%
 \@x{\@s{12.29} {\p@lbrace} S\@s{.5}\textrm{:}\@s{3} {\p@while} {\p@lparen}
 {\TRUE} {\p@rparen}}%
\@x{\@s{12.29} {\p@lbrace} {\p@either}}%
 \@x{ A1blue\@s{.5}\textrm{:}\@s{3} {\p@lbrace} {\p@await} ( blue \.{>} 1 )
 {\p@semicolon}\@s{4.1}}%
\@y{%
 same color and blue
}%
\@xx{}%
 \@x{\@s{46.16} blue \.{:=} blue \.{-} 2 {\p@semicolon} green \.{:=} green
 \.{+} 1 {\p@semicolon} red \.{:=} red \.{+} 1 {\p@semicolon}}%
\@x{ {\p@rbrace} {\p@semicolon}}%
\@x{\@s{29.81} {\p@or}}%
 \@x{ A1red\@s{.5}\textrm{:}\@s{3} {\p@lbrace} {\p@await} ( red \.{>} 1 )
 {\p@semicolon}\@s{4.1}}%
\@y{%
 same color and red
}%
\@xx{}%
 \@x{\@s{46.33} red \.{:=} red \.{-} 2 {\p@semicolon} green \.{:=} green \.{+}
 1 {\p@semicolon} blue \.{:=} blue \.{+} 1 {\p@semicolon}}%
\@x{ {\p@rbrace} {\p@semicolon}}%
\@x{\@s{29.81} {\p@or}}%
 \@x{ A1green\@s{.5}\textrm{:}\@s{3} {\p@lbrace} {\p@await} ( green \.{>} 1 )
 {\p@semicolon}\@s{4.1}}%
\@y{%
 same color and green
}%
\@xx{}%
 \@x{\@s{42.09} green \.{:=} green \.{-} 2 {\p@semicolon} blue \.{:=} blue
 \.{+} 1 {\p@semicolon} red \.{:=} red \.{+} 1 {\p@semicolon}}%
\@x{ {\p@rbrace} {\p@semicolon}}%
\@x{\@s{29.81} {\p@or}}%
 \@x{ A2rg\@s{.5}\textrm{:}\@s{3} {\p@lbrace} {\p@await} ( red \.{>} 0
 \.{\land} green \.{>} 0 ) {\p@semicolon}}%
\@y{%
 different color red and green
}%
\@xx{}%
 \@x{\@s{37.48} red \.{:=} red \.{-} 1 {\p@semicolon} green \.{:=} green \.{-}
 1 {\p@semicolon} blue \.{:=} blue \.{+} 1 {\p@semicolon}}%
\@x{ {\p@rbrace} {\p@semicolon}}%
\@x{\@s{29.81} {\p@or}}%
 \@x{ A2gb\@s{.5}\textrm{:}\@s{3} {\p@lbrace} {\p@await} ( blue \.{>} 0
 \.{\land} green \.{>} 0 ) {\p@semicolon}}%
\@y{%
 different color blue and green
}%
\@xx{}%
 \@x{\@s{38.12} blue \.{:=} blue \.{-} 1 {\p@semicolon} green \.{:=} green
 \.{-} 1 {\p@semicolon} red \.{:=} red \.{+} 1 {\p@semicolon}}%
\@x{ {\p@rbrace} {\p@semicolon}}%
\@x{\@s{29.81} {\p@or}}%
 \@x{ A2br\@s{.5}\textrm{:}\@s{3} {\p@lbrace} {\p@await} ( red \.{>} 0
 \.{\land} blue \.{>} 0 ) {\p@semicolon}}%
\@y{%
 different color red and blue
}%
\@xx{}%
 \@x{\@s{38.18} red \.{:=} red \.{-} 1 {\p@semicolon} blue \.{:=} blue \.{-} 1
 {\p@semicolon} green \.{:=} green \.{+} 1 {\p@semicolon}}%
\@x{ {\p@rbrace} {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{\@s{17.51} {\p@rbrace}}%
\@y{%
...
\@xx{}%
\@x{ {\VARIABLES} red ,\, blue ,\, green ,\, pc}%
\@pvspace{8.0pt}%
\@x{ vars \.{\defeq} {\langle} red ,\, blue ,\, green ,\, pc {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Init\@s{2.02} \.{\defeq}}%
\@y{\@s{0}%
 Global variables
...
\@xx{}%
\@x{\@s{37.72} \.{\land} red \.{=} R}%
\@x{\@s{37.72} \.{\land} blue \.{=} B}%
\@x{\@s{37.72} \.{\land} green \.{=} G}%
\@x{\@s{37.72} \.{\land} pc \.{=}\@w{S}}%
\@pvspace{8.0pt}%
\@x{ S \.{\defeq} \.{\land} pc \.{=}\@w{S}}%
\@x{\@s{25.70} \.{\land} \.{\lor} \.{\land} pc \.{'} \.{=}\@w{A1blue}}%
\@x{\@s{36.81} \.{\lor} \.{\land} pc \.{'} \.{=}\@w{A1red}}%
\@x{\@s{36.81} \.{\lor} \.{\land} pc \.{'} \.{=}\@w{A1green}}%
\@x{\@s{36.81} \.{\lor} \.{\land} pc \.{'} \.{=}\@w{A2rg}}%
\@x{\@s{36.81} \.{\lor} \.{\land} pc \.{'} \.{=}\@w{A2gb}}%
\@x{\@s{36.81} \.{\lor} \.{\land} pc \.{'} \.{=}\@w{A2br}}%
 \@x{\@s{25.70} \.{\land} {\UNCHANGED} {\langle} red ,\, blue ,\, green
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ A1blue \.{\defeq} \.{\land} pc \.{=}\@w{A1blue}}%
\@x{\@s{49.19} \.{\land} ( blue \.{>} 1 )}%
\@x{\@s{49.19} \.{\land} blue \.{'} \.{=} blue \.{-} 2}%
\@x{\@s{49.19} \.{\land} green \.{'} \.{=} green \.{+} 1}%
\@x{\@s{49.19} \.{\land} red \.{'} \.{=} red \.{+} 1}%
\@x{\@s{49.19} \.{\land} pc \.{'} \.{=}\@w{S}}%
\@pvspace{8.0pt}%
\@x{ A1red \.{\defeq} \.{\land} pc \.{=}\@w{A1red}}%
\@x{\@s{45.26} \.{\land} ( red \.{>} 1 )}%
\@x{\@s{45.26} \.{\land} red \.{'} \.{=} red \.{-} 2}%
\@x{\@s{45.26} \.{\land} green \.{'} \.{=} green \.{+} 1}%
\@x{\@s{45.26} \.{\land} blue \.{'} \.{=} blue \.{+} 1}%
\@x{\@s{45.26} \.{\land} pc \.{'} \.{=}\@w{S}}%
\@pvspace{8.0pt}%
\@x{ A1green \.{\defeq} \.{\land} pc \.{=}\@w{A1green}}%
\@x{\@s{54.70} \.{\land} ( green \.{>} 1 )}%
\@x{\@s{54.70} \.{\land} green \.{'} \.{=} green \.{-} 2}%
\@x{\@s{54.70} \.{\land} blue \.{'} \.{=} blue \.{+} 1}%
\@x{\@s{54.70} \.{\land} red \.{'} \.{=} red \.{+} 1}%
\@x{\@s{54.70} \.{\land} pc \.{'} \.{=}\@w{S}}%
\@pvspace{8.0pt}%
\@x{ A2rg\@s{0.70} \.{\defeq} \.{\land} pc \.{=}\@w{A2rg}}%
\@x{\@s{41.21} \.{\land} ( red \.{>} 0 \.{\land} green \.{>} 0 )}%
\@x{\@s{41.21} \.{\land} red \.{'} \.{=} red \.{-} 1}%
\@x{\@s{41.21} \.{\land} green \.{'} \.{=} green \.{-} 1}%
\@x{\@s{41.21} \.{\land} blue \.{'} \.{=} blue \.{+} 1}%
\@x{\@s{41.21} \.{\land} pc \.{'} \.{=}\@w{S}}%
\@pvspace{8.0pt}%
\@x{ A2gb\@s{0.06} \.{\defeq} \.{\land} pc \.{=}\@w{A2gb}}%
\@x{\@s{41.21} \.{\land} ( blue \.{>} 0 \.{\land} green \.{>} 0 )}%
\@x{\@s{41.21} \.{\land} blue \.{'} \.{=} blue \.{-} 1}%
\@x{\@s{41.21} \.{\land} green \.{'} \.{=} green \.{-} 1}%
\@x{\@s{41.21} \.{\land} red \.{'} \.{=} red \.{+} 1}%
\@x{\@s{41.21} \.{\land} pc \.{'} \.{=}\@w{S}}%
\@pvspace{8.0pt}%
\@x{ A2br \.{\defeq} \.{\land} pc \.{=}\@w{A2br}}%
\@x{\@s{41.21} \.{\land} ( red \.{>} 0 \.{\land} blue \.{>} 0 )}%
\@x{\@s{41.21} \.{\land} red \.{'} \.{=} red \.{-} 1}%
\@x{\@s{41.21} \.{\land} blue \.{'} \.{=} blue \.{-} 1}%
\@x{\@s{41.21} \.{\land} green \.{'} \.{=} green \.{+} 1}%
\@x{\@s{41.21} \.{\land} pc \.{'} \.{=}\@w{S}}%
\@pvspace{8.0pt}%
 \@x{ Next\@s{1.38} \.{\defeq} S \.{\lor} A1blue \.{\lor} A1red \.{\lor}
 A1green \.{\lor} A2rg \.{\lor} A2gb \.{\lor} A2br}%
\@pvspace{8.0pt}%
 \@x{ Spec\@s{2.85} \.{\defeq} \.{\land} Init \.{\land} {\Box} [ Next ]_{
 vars}}%
\@x{\@s{41.21} \.{\land} {\WF}_{ vars} ( Next )}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 END TRANSLATION
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{ Termination \.{\defeq} {\Diamond} ( red \.{+} green \.{+} blue \.{=} 1
 )}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Project Group Members: \ensuremath{Ankit}
 \ensuremath{Jain(5009} \ensuremath{7432)}, Milky \ensuremath{Sahu(5009}
 \ensuremath{6350)
}%
\end{cpar}%
\vshade{15.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}*Consider a coffee can containing an arbitrary
 (but finite) number of beans. The beans come
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{\,\backslash\,}}*in 3 different colors: red, green, and blue.
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{\,\backslash\,}}*Now consider the following program:
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{\,\backslash\,}}*Choose two beans from the can;
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}*if they are the same color, toss them out and
 add two beans for the other two colors
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}*if they are different colors, toss them out
 and add a bean of the third color
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{\,\backslash\,}}*Repeat.
\end{cpar}%
\vshade{15.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{\,\backslash\,}}* ANSWER 1:
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{\,\backslash\,}}* 3 Invariant Conditions
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{\,\backslash\,}}* \ensuremath{red\.{+}green\.{+}blue\.{>}0
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* \ensuremath{red\.{+}blue\.{\leq}400 \.{\lor}
 blue\.{+}green\.{\leq}400 \.{\lor} green\.{+}red \.{\leq}400
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* \ensuremath{red\.{+}green \.{>} 0 \.{\lor}
 green\.{+}blue \.{>}0
}%
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{\,\backslash\,}}* ANSWER 2:
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{\,\backslash\,}}* Fixed Point of the Program:
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Since invariant is
 \ensuremath{red\.{+}green\.{+}blue\.{>}0} \ensuremath{i.e}. this condition
 is always satisfied for the program. Now the fixed point can be reached
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* when the quantity of beans for any two
 colors falls below 1 in the can and only 1 third bean is present so that
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* that they don\mbox{'}t get picked up in the
 next iteration (either for same color or different color)
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* (\ensuremath{green \.{\leq} 1 \.{\land}}
 (\ensuremath{red \.{\leq}0 \.{\land} blue \.{\leq}0})) \ensuremath{\.{\lor}}
 (\ensuremath{blue \.{\leq} 1 \.{\land}} (\ensuremath{red \.{\leq} 0 \.{\lor}
 green \.{\leq}0})) \ensuremath{\.{\lor}} (\ensuremath{red \.{\leq} 1
 \.{\land}} (\ensuremath{blue \.{\leq}0 \.{\land} green \.{\leq}0}))
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{\,\backslash\,}}* ANSWER 3:
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{\,\backslash\,}}* Variant Function or metric function
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{\,\backslash\,}}* \ensuremath{red\.{+}green\.{+}blue
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* As a metric, we choose
 \ensuremath{red\.{+}green\.{+}blue}. This value is bounded below, as evident
 by the invariant.
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Also, it never increases since the rate of
 decrement in number of beans is greater than their rate of increment.
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* (As, when the beans tossed out are of same
 color, the count of beans in the box remains the same. If the beans tossed
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* out are of different colors, then the rate
 of decrement is greater than the increment)
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{\,\backslash\,}}* Therefore, this program terminates.
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Sep} 30 18:19:51 \ensuremath{EDT} 2014 by \ensuremath{Ankit
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Thu} \ensuremath{Sep} 25
 11:02:02 \ensuremath{EDT} 2014 by \ensuremath{Ankit
}%
\end{cpar}%
\end{lcom}%
\end{document}
